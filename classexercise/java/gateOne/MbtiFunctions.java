public class MbtiFunctions{

	public static String finalResult (String finalResult){
	String message = "none";
	if (finalResult.equals("INTJ")){
		...
		J - Judging
		  ...
		  Logical and quick-witted, INTJs pride themselves on their ability to think for themselves, not to mention their uncanny knack for seeing right through phoniness andhypocrisy. Because their minds are never at rest, these personalities may sometimes struggle to find people who can keep up with their nonstop analysis of everything around them. But when they do find like-minded individuals who appreciate their intensity and depth of thought, INTJs form profound and intellectually stimulating relationships that they deeply treasure.
	 ...
	 else if (finalResult.equals("INTP")){
		message = """
			 I - Introverted
			 N - Intutive
			 T - Thinking 
	...
	else if (finalResult.equals("ENTJ")){
		message = """
			E - Extraverted
			N - Intuitive
			T - Thinking
	...
	If there’s anything that people with this personality type love, it’s a good challenge, big or small, and they firmly believe that, given enough time and resources, they can achieve any goal. This quality makes ENTJs brilliant entrepreneurs, and their ability to think strategically and hold a long-term focus while executing each step of their plans with determination and precision makes them powerful business leaders.""";
	...
	else if (finalResult.equals("ENTP")){
		message = """
			E - Extraverted 
			N - Intuitive
			T - Thinking
		...
		ENTP is a personality type with the Extraverted, Intuitive, Thinking, and Prospecting traits. They tend to be bold and creative, deconstructing and rebuilding ideas with great mental agility. They pursue their goals vigorously despite any resistance they might encounter.
		...
		else if (finalResult.equals("INFJ")){
		    message = """
			I - Introverted 
			N - Intuitive
			F - Feeling
		...
		INFJ is a personality type with the Introverted, Intuitive, Feeling, and Judging traits. They tend to approach life with deep thoughtfulness and imagination. Their inner vision, personal values, and a quiet, principled version of humanism guide them in all things.
		...
		else if(finalResult.equals("INFP")){
		...
		message = """
			...
			INFP is a personality type with the Introverted, Intuitive, Feeling, and Prospecting traits. These rare personality types tend to be quiet, open-minded, and imaginative, and they apply a caring and creative approach to everything they do.
		...
		else if(finalResult.equals("ENFJ")){
			message = """
				E - Extraverted 
				N - Intuitive
				F - Feeling
		...
		else if (finalResult.equals("ENFP")){
			message = """
				E - Extraverted 
				N - Intuitive 
				F - Feeling 
			...
			ENFP is a personality type with the Extraverted, Intuitive, Feeling, and Prospecting traits. These people tend to embrace big ideas and actions that reflect their sense of hope and goodwill toward others. Their vibrant energy can flow in many directions.
		...
		else if (finalResult.equals("ISTJ")){
			message = """
				  I - Introverted 
				  S - Observant 
				  T - Thinking 
		...
		else if (finalResult.equals("ISFj")){
			message = """
				I - Introverted 
				S - Observant 
				F - Feeling 
				...
				ISFJ  is a personality type with the Introverted, Observant, Feeling, and Judging traits. These people tend to be warm and unassuming in their own steady way. They’re efficient and responsible, giving careful attention to practical details in their daily lives.
		...
		else if (finalResult.equals("ESTJ")){
				message = """
					E - Extraverted 
					S - Observant 
					T - Thinking 
					...
					ESTJ is a personality type with the Extraverted, Observant, Thinking, and Judging traits. They possess great fortitude, emphatically following their own sensible judgment. They often serve as a stabilizing force among others, able to offer solid direction amid adversity.
		...
		else if (finalResult.equals("ESfJ")){
			message = """
				E - Extraverted 
				S - Observant 
				F - Feeling 
				...
				ESFJ is a personality type with the Extraverted, Observant, Feeling, and Judging traits. They are attentive and people-focused, and they enjoy taking part in their social community. Their achievements are guided by decisive values, and they willingly offer guidance to others.

			      For people with the ESFJ personality type, life is sweetest when it’s shared with others. These social individuals form the bedrock of many communities, opening their homes – and their hearts – to friends, loved ones, and neighbors.
			...
			else if (finalResult.equals("ISTP")){
				message = """
					 I - Introverted 
					 S - Observant
					 T - Thinking 
					...
					ISTP is a personality type with the Introverted, Observant, Thinking, and Prospecting traits. They tend to have an individualistic mindset, pursuing goals without needing much external connection. They engage in life with inquisitiveness and personal skill, varying their approach as needed.
		...
		else if (finalResult.equals("ISFP")){
			message = """
				  I - Intoverted 
				  S - Observant 
				  F - Feeling 
				 ...
				 ISFP is a personality type with the Introverted, Observant, Feeling, and Prospecting traits. They tend to have open minds, approaching life, new experiences, and people with grounded warmth. Their ability to stay in the moment helps them uncover exciting potentials.
			...
			else if (finalResult.equals("ESTP")){
				message = """
					E - Extraverted 
					S - Observant
					T - Thinking 
					...
					ESTP is a personality type with the Extraverted, Observant, Thinking, and Prospecting traits. They tend to be energetic and action-oriented, deftly navigating whatever is in front of them. They love uncovering life’s opportunities, whether socializing with others or in more personal pursuits.
				...
				message ="""
					...
					ESFP is a personality type with the Extraverted, Observant, Feeling, and Prospecting traits. These people love vibrant experiences, engaging in life eagerly and taking pleasure in discovering the unknown. They can be very social, often encouraging others into shared activities.
	
					If anyone is to be found spontaneously breaking into song and dance, it is people with the ESFP personality type. They get caught up in the excitement of the moment and want everyone else to feel that way too. No other type is as generous with their time and energy when it comes to encouraging others, and no other type does it with such irresistible style.""";
				}
